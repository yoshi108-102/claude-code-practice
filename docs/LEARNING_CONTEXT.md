...
|---|---|---|---|---|
| 1 | 基礎 — Claude Code の世界観を掴む | agentic loop / CLI基本 / 各Surface (CLI/VS Code/Desktop/Web/JetBrains/Chrome) / context window / checkpointing | 32 | 🚧 進行中 (Task 2/8) |
...
**Phase 1 / Task 2**: CLI の基本操作 の学習段階。Task 1（概論 & クイックスタート）完了、復習キュー 5 件あり。
